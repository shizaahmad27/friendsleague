...
let InvitationsController = class InvitationsController {
    ...
    async useInvitation(req, useInvitationDto) {
        const userId = req.user.id;
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], InvitationsController.prototype, "getInvitations", null);
__decorate([
    (0, common_1.Post)('use'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, invitation_dto_1.UseInvitationDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], InvitationsController.prototype, "getMyInviteCode", null);
