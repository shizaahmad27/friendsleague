...
async function main() {
  ...
  try {
    ...
    console.log('✅ Created sample league with members and rules');
    ...
    console.log('✅ Created sample event with participants');

    console.log('🎉 Database seeding completed successfully!');
    console.log('\n📋 Summary:');
    console.log(`- Created ${users.length} users`);
    console.log(`- Created ${friendships.length} friendships`);
    console.log('- Created 1 league with 3 members');
    console.log('- Created 1 group chat with 3 participants');
    console.log('- Created 1 event with 3 participants');
