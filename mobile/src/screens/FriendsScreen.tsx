      ...
      <View style={styles.content}>
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.cardButton}>
            <Text style={styles.cardButtonText}>Add Friends</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardDescription}>
            Search for friends by username or phone number
          </Text>
          <TouchableOpacity style={styles.cardButton}>
            <Text style={styles.cardButtonText}>Search</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.cardButton}>
            <Text style={styles.cardButtonText}>Send Invites</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
